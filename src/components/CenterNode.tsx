...
export const CenterNode = ({ node, x, y }: CenterNodeProps) => (
  <motion.div
    key={node.id}
    className="absolute z-10 h-[180px] w-64 -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-violet-300/35 bg-gradient-to-br from-violet-500/20 to-cyan-400/10 p-5 shadow-glow backdrop-blur"
    style={{ left: x, top: y }}
